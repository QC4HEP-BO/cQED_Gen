...
class ThreeQubitCapacitiveStar(DatasetBase):
    ...
    def build_topology(cls) -> CQEDTopology:
        ...
        cc13 = t.add_node(SubgType.C_COUPLER, {"Cc": 0.0},           label="Cc13")
        cc23 = t.add_node(SubgType.C_COUPLER, {"Cc": 0.0},           label="Cc23")
        t.add_edge(t1, cc12); t.add_edge(cc12, t2)
        t.add_edge(t1, cc13); t.add_edge(cc13, t3)
        t.add_edge(t2, cc23); t.add_edge(cc23, t3)
        return t
    ...
    def parse_row(cls, line: str):
        ...
        if len(nums) < 7:
            return None, None
        Cq, Lq1, Lq2, Lq3, Cc12, Cc13, Cc23 = nums[:7]
